...
bash <(curl -fsSL https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/install.sh)

# Quick install with profile
bash <(curl -fsSL https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/install.sh) developer
```
...
bash <(curl -fsSL https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/install.sh) essential

# Developer - Code-focused development tools
bash <(curl -fsSL https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/install.sh) developer

# Business - Content and business-focused tools
bash <(curl -fsSL https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/install.sh) business

# Full - Everything except system-builder
bash <(curl -fsSL https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/install.sh) full

# Advanced - Complete system with all components
bash <(curl -fsSL https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/install.sh) advanced
```
...
- **Documentation:** [GitHub Repository](https://github.com/johnneerdael/OpenAgents)
- **Report issues:** [GitHub Issues](https://github.com/johnneerdael/OpenAgents/issues)
