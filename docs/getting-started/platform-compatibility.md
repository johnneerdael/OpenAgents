...
curl -fsSL https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/install.sh | bash -s core
```
...
curl -fsSL https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/scripts/tests/test-compatibility.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/install.sh > install.sh
