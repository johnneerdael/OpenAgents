...
if curl -fsSL --max-time 5 https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/README.md > /dev/null 2>&1; then
...
echo "  curl -fsSL https://raw.githubusercontent.com/johnneerdael/OpenAgents/main/install.sh | bash"
echo ""
